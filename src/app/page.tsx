...
export default function Home() {
  ...
  return (
    <div className="min-h-screen lg:h-screen flex flex-col bg-surface-300 lg:overflow-hidden">
      <Header />

      <main className="flex-1 flex flex-col min-h-0 overflow-auto lg:overflow-hidden">
        <Tabs
          value={activeTab}
        ...
        >
          ...
          <div className="flex-1 min-h-0 overflow-auto lg:overflow-hidden p-2">
